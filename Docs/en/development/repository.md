...
The workspace contains three child workspaces:
...
`@mauriciodmo/framekit` must be built **before** Studio can run. Studio declares `@mauriciodmo/framekit` with a `workspace:*` link:
...
| ---------------------------------- | --------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| `src/generated/framekit/templates.ts` | Auto-generated canonical template registry                                           | **Ignored** — regenerated by `dev`, `check`, `build`, or `framekit generate` |
...
**`packages/create-framekit/template/`** — The canonical consumer project copied by `create-framekit`. Isolated distribution consumers are created temporarily outside this repository.
