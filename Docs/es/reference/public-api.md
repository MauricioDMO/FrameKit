...
| `Markdown`                   | Renderiza contenido markdown con componentes personalizables                                                                          |
...
| `resolveTemplateData`        | Resuelve los datos de una plantilla, aplicando valores por defecto y resolviendo variantes de locale                                  |
| `getLocales`                 | Extrae todos los locales definidos en una plantilla a partir de su estructura de campos                                               |
| `getDefaultValues`           | Extrae los valores por defecto de todos los campos a partir de una definición de plantilla                                            |
...
| `Markdown`                                               | Cliente   | Componente React que renderiza interfaz de usuario                                                                                             |
