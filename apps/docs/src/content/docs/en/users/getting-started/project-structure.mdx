...
:::caution
`.framekit-data/` is different: when authentication is enabled, it contains the
default SQLite database. Treat it as persistent runtime data and do not delete it
as part of generated-output cleanup. Open mode does not initialize this database.
:::
