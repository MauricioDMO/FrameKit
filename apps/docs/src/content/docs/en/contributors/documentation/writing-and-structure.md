...
Legacy `Docs/en/` and `Docs/es/` pages can reveal migration topics, but they are
not authority over current code. `Docs/Plans/` records work coordination, not
product behavior. Do not copy historical commands or describe unsupported
