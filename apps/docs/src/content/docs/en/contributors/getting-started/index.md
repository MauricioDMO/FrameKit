...
description: Take a clean FrameKit checkout from its runtime prerequisites to local development.
---
...
If you are setting up a generated FrameKit application rather than contributing to this repository, use [user getting started](/en/users/getting-started) instead. The contributor path does not replace the consumer setup or API references.
