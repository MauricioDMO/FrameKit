...
4. **Abre Studio.**
   ...
   Visita `http://localhost:3000/editor` y elige la plantilla. Esto funciona sin
   iniciar sesión en el modo abierto predeterminado. Si
   `FRAMEKIT_AUTH_ENABLED=true`, visita `/login`, inicia sesión y elige después
   la plantilla desde `/editor`.
