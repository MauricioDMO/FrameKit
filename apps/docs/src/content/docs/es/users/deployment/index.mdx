...
description: Prepara Chromium, la autenticación opcional, SQLite, los secretos y un proceso de Node.js de larga duración antes de exponer FrameKit públicamente.
sidebar:
  order: 1
---
