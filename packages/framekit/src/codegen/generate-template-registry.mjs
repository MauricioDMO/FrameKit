...
const projectRootArgument = process.argv[2] === '--' ? process.argv[3] : process.argv[2]
const PROJECT_ROOT = projectRootArgument ? path.resolve(projectRootArgument) : process.cwd()
