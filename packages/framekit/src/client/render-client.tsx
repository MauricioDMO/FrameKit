...
export function createRenderClient (templates: readonly TemplateRegistryEntry[]) {
  return function RenderClient ({ payload }: RenderClientProps) {
    ...
    useEffect(() => {
      ...
      // The ready marker is published only after the committed canvas render.
      setSnapshot((current) => {
