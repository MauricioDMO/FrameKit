  ...
  return (
    <div className="space-y-2">
      <div className="overflow-hidden rounded-xl border border-[#d6d5ce] bg-[#efeee9] dark:border-white/15 dark:bg-[#24342c]">
        {value && !loadFailed ? (
          <img src={value} alt="" onError={() => setLoadFailed(true)} className="block max-h-40 w-full object-contain" />
        ) : (
      ...
      {onImageUpload && imageLabels && (
        <label className="inline-flex cursor-pointer items-center rounded-lg border border-[#cccec8] bg-white px-3 py-2 text-xs font-bold text-[#4e5a53] transition hover:bg-[#efeee9] has-disabled:cursor-not-allowed has-disabled:opacity-50 dark:border-white/15 dark:bg-[#24342c] dark:text-[#d7e2dc] dark:hover:bg-[#2d4036]">
