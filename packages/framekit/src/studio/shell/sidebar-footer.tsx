...
export function SidebarFooter ({ user, messages, locale, onLocaleChange, settingsOpen, onToggleSettings }: SidebarFooterProps) {
  return (
    <div className="relative mt-auto shrink-0 border-t border-white/10 px-5 py-4">
      ...
      <div className="relative mt-3">
        ...
        <button
          ...
          className="mt-2 inline-flex min-h-10 w-full items-center justify-center gap-2 rounded-lg border border-white/20 bg-white/10 px-3 text-sm font-bold text-fk-mint-200 transition hover:bg-white/15 focus:ring-2 focus:ring-fk-mint-200 focus:outline-none"
        >
