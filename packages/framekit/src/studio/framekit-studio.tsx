...
export function FrameKitStudio({ templates, brands = emptyBrands }: { templates: readonly FrameKitStudioTemplate[], brands?: readonly FrameKitStudioBrand[] }) {
  ...
  else if (loadState.status === 'ready' && loadState.kind === 'template') content = <FrameKitEditor key={slug} slug={slug} definition={loadState.definition} assets={loadState.assets} messages={messages.editor} />
