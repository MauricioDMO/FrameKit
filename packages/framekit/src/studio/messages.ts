...
export const frameKitMessages: Record<FrameKitLocale, FrameKitStudioMessages> = {
  es: {
    ...
    editor: { templateEditor: 'Editor de plantilla', reset: 'Restablecer', generating: 'Generando...', downloadPng: 'Descargar PNG', content: 'Contenido', preview: 'Vista previa', actualSize: 'Tamaño real', fitToView: 'Ajustar', contentLanguageLabel: 'Idioma del diseño', exportError: 'No se pudo exportar la plantilla:', exportAlert: 'No fue posible generar la imagen.', loadingLabel: 'Cargando...', loadError: 'Error al cargar la plantilla', invalidDefinition: 'La plantilla no es válida', errorRequired: 'Este campo es requerido', errorInvalidNumber: 'Ingresa un número válido', errorNumberTooSmall: 'El valor debe ser mayor o igual a {min}', errorNumberTooLarge: 'El valor debe ser menor o igual a {max}', errorInvalidUrl: 'Ingresa una URL válida', errorInvalidColor: 'Ingresa un color hexadecimal válido (#RRGGBB)', imageSelect: 'Subir imagen', imageUploading: 'Subiendo...', imageLoadError: 'No se pudo cargar el asset', imageUploadError: 'No se pudo subir el asset' },
