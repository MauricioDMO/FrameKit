...
export const inputClass = 'mt-2 min-h-11 w-full rounded-xl border border-fk-ivory-400 bg-white px-3 text-sm text-fk-forest-400 outline-none transition placeholder:text-fk-sage-400 focus:ring-2 focus:ring-fk-forest-300 dark:border-white/15 dark:bg-fk-forest-100 dark:text-white dark:placeholder:text-fk-sage-300 dark:focus:ring-fk-mint-200'
export const selectClass = 'mt-2 min-h-11 w-full rounded-xl border border-fk-ivory-400 bg-white px-3 text-sm text-fk-forest-400 outline-none transition focus:ring-2 focus:ring-fk-forest-300 dark:border-white/15 dark:bg-fk-forest-100 dark:text-white dark:focus:ring-fk-mint-200'
export const primaryButtonClass = 'inline-flex min-h-11 items-center justify-center rounded-xl bg-fk-forest-300 px-4 text-sm font-bold text-white transition hover:bg-fk-forest-400 focus:ring-2 focus:ring-fk-mint-300 focus:outline-none disabled:cursor-wait disabled:opacity-60'
export const secondaryButtonClass = 'inline-flex min-h-11 items-center justify-center rounded-xl border border-fk-forest-300 px-4 text-sm font-bold text-fk-forest-300 transition hover:bg-fk-ivory-300 focus:ring-2 focus:ring-fk-forest-300 focus:outline-none disabled:cursor-wait disabled:opacity-60 dark:border-fk-mint-200 dark:text-fk-mint-200 dark:hover:bg-white/10 dark:focus:ring-fk-mint-200'
export const dangerButtonClass = 'inline-flex min-h-11 items-center justify-center rounded-xl border border-red-700/25 px-4 text-sm font-bold text-red-800 transition hover:bg-red-50 focus:ring-2 focus:ring-red-700/40 focus:outline-none disabled:cursor-wait disabled:opacity-60 dark:border-red-200/30 dark:text-red-100 dark:hover:bg-red-950/30'
