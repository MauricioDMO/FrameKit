...
export const primaryButtonClass = 'inline-flex min-h-10 items-center justify-center rounded-lg bg-fk-forest-300 px-4 text-sm font-bold text-fk-ivory-100 transition hover:bg-fk-forest-400 focus:ring-2 focus:ring-fk-mint-300 focus:outline-none disabled:cursor-wait disabled:opacity-60 outline outline-fk-ivory-400/50'
