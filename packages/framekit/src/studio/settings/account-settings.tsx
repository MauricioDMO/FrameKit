...
export function AccountSettings ({ user, messages, errors, onUserChange, onSessionEnded }: AccountSettingsProps) {
  ...
  return (
    <SettingsCard id="framekit-settings-account" title={messages.title} description={messages.description}>
      ...
      <form onSubmit={updateUsername} aria-busy={usernamePending} className="mt-6 border-t border-fk-ivory-400 pt-5 dark:border-white/10">
      ...
      <form onSubmit={logout} className="mt-6 border-t border-fk-ivory-400 pt-5 dark:border-white/10">
        ...
        <div className="mt-3"><Feedback {...logoutFeedback} /></div>
      </form>
    </SettingsCard>
  )
}
