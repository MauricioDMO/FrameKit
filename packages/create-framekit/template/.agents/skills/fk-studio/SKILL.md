...
3. State the cause, smallest fix, and limitation. Do not promise server sync, collaboration, non-PNG export, scale/DPI controls, or languages beyond English and Spanish.
